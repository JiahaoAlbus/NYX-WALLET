...
public final class BTCAdapter: ChainAdapter {
    ...
    public func estimateNetworkFee(draft: TransactionDraft) async throws -> Decimal {
        // TODO: Implement fee estimation using mempool API.
        return 0.0001
    }

    public func buildRawTransaction(draft: TransactionDraft, serviceFee: Decimal) async throws -> Data {
        // TODO: Implement UTXO selection and add service fee output to feeRecipient.address.
